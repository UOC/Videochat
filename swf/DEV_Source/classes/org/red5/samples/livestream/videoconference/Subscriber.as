...
// Public Methods:
	...
	public function subscribe(p_subscriptionID:String, p_connection:Connection):Void
	{
		...
		//cmoyas
		//_root.getURL("javascript:alert('1- Subscriber->subscribe"+connected+"')");
		
		si = setInterval(this, "doubleCheckTime", 10000);
...
// Private Methods:
	...
	{
		//cmoyas
		//_root.getURL("javascript:alert('2- Subscriber->doubleCheckTime')");
	...
	{
		//cmoyas
		//_root.getURL("javascript:alert('3- Subscriber->reset')");
		connected = false;
		userName.text = "";
		noStream._visible = false;
		publish_video.clear();
