...
public class MP3Header {
    ...
    public MP3Header(int data) throws Exception {
		...
		System.out.println("=================================================================");
		System.out.println("audioVersionId: " + audioVersionId);
		System.out.println("layerDescription: " + layerDescription);
		System.out.println("protectionBit: " + protectionBit);
		System.out.println("bitRateIndex: " + bitRateIndex);
		System.out.println("samplingRateIndex: " + samplingRateIndex);
		System.out.println("paddingBit: " + paddingBit);
		System.out.println("channelMode: " + channelMode);
		System.out.println("=================================================================");		
	}
