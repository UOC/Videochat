...
// Initialization:
	private function Broadcaster() {
		...
		//scope=_level0.var1.toString();
		//fullName=_level0.var2.toString();
		//email=_level0.var3.toString();
		
		//connector.connection.call("getParams", connector.connection, scope, fullName, email)
		//nc.call("add", nc, fullName, email);
		//nc.call("add", nc, scope, fullName, email);
	}
...
// Private Methods:
	...
	{
		this.stream.publish("rec","record");
	}*/
